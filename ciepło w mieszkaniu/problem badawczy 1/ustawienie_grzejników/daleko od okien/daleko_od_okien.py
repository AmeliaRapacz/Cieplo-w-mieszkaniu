...
class House:
    def __init__(self, initial_temperature, outside_temperature, times, knobs):
        ...
        self.heaters = [
            Heater(room1, [85,106], [64, 65, 86, 107, 128, 127], knobs),
            Heater(room1, [157, 158], [156,135,136,137,138,159],knobs),
            Heater(room2, [23,24], [22,35,36,37], knobs),
            Heater(room2, [127,128], [126,113,114,115], knobs),
            Heater(room3, [14,15], [13,24,25,26,27,16],knobs),
            Heater(room4, [77,96], [58,59,78,97,116,115], knobs),
            Heater(room4, [30,31,32,33], [29,48,49,50,51,52,53,34],knobs)
        ]
    ...
    def main(self):
        ...
        for t in np.arange(1, self.times):
            ...
            if t % 7200 == 0:  
                ...
                plt.show()
                plt.savefig(f"temperature_po_godzinie{t/(900)*60}_grzania.png") 
                plt.close()
