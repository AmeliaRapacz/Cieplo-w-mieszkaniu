...
class House:
    def __init__(self, initial_temperature, outside_temperature, times, knobs):
        ...
        self.windows = [
            ...
            Window(room2, [52,65], outside_temperature),
        ...
        self.heaters = [
            Heater(room1, [23, 24], [22,43,44,45,46,25],knobs),
            Heater(room1, [34, 35], [33,36,54,55,56,57], knobs),
            Heater(room2, [121,122], [120,107,108,109,110,123],knobs),
            Heater(room2, [53,66], [40,41,54,67,80,79], knobs),
            Heater(room3, [53,64], [42,41,53,63,74,75], knobs),
            Heater(room4, [112,131], [92,93,149,150,130,111],knobs),
