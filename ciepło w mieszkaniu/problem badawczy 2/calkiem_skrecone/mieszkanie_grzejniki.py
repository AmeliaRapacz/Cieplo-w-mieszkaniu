...
class House:
    def __init__(self, initial_temperature, outside_temperature, times, knobs):
        ...
        self.heaters = [
            Heater(room1, [34, 35], [33,54,55,56,57,36], knobs),
            Heater(room2, [121,122], [120,107,108,109,110,123], knobs),
            Heater(room2, [53,66], [40,41,54,67,80,79], knobs),
            Heater(room3, [53,64], [42,41,52,63,74,75], knobs),
            Heater(room4, [93,112,131,150], [74,73,92,111,130,149,168,169], knobs),
            Heater(room4, [178,179], [177,158,159,160,161,180], knobs)
        ]
    ...
    def main(self, czas_wyjścia_z_domu, czas_wejścia_do_domu, stare_max, nowe_max):
        ...
        for t in np.arange(1, self.times):  
            ...
            for heater in self.heaters:
                ...
                if t == czas_wyjścia_z_domu:
                    heater.termostats(nowe_max)
                if t == czas_wejścia_do_domu:
                    heater.termostats(stare_max)
        ...
        if t % 7200 == 0 or (t % 900 == 0 and t >= 7200 * 8 and t < 7200 * 9) or (t % 900 == 0 and t >= 7200 * 15 and t < 7200 * 16):
            ...
            plt.title(f"Temperatura po {(t/7200)} h")
